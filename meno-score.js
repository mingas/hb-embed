/* The Hormone Blueprint - Menopause Symptom Score
   Self-contained embeddable quiz. Mounts into #meno-quiz (or a div with
   data-meno-quiz). Based on the public-domain Menopause Rating Scale (MRS).
...
(function () {
  ...
  var EMBED_SRC = SITE + "/menopause-score?embed=1";
  ...
  var Q = [
    { t: "Hot flushes, sweating", h: "Episodes of heat, or night sweats", g: 0 },
    { t: "Heart discomfort", h: "Racing, skipping, or a pounding heartbeat", g: 0 },
    { t: "Sleep problems", h: "Trouble falling asleep, staying asleep, or waking early", g: 0 },
    { t: "Depressive mood", h: "Feeling low, sad, tearful, or lacking drive", g: 1 },
    { t: "Irritability", h: "Feeling tense, on edge, or easily annoyed", g: 1 },
    { t: "Anxiety", h: "Inner restlessness, or feeling panicky", g: 1 },
    { t: "Physical and mental exhaustion", h: "Low energy, poor concentration, forgetfulness", g: 1 },
    { t: "Sexual problems", h: "A change in desire, activity, or satisfaction", g: 2 },
    { t: "Bladder problems", h: "Going more often, urgency, or leaks", g: 2 },
    { t: "Vaginal dryness", h: "Dryness or discomfort, especially during sex", g: 2 },
    { t: "Joint and muscular discomfort", h: "Aches, joint pain, or stiffness", g: 0 }
  ];
  var OPTS = ["None", "Mild", "Moderate", "Severe", "Very severe"];
  var GROUP_NAMES = ["Body (flushes, heart, sleep, joints)", "Mood and mind", "Intimate and urinary"];
  ...
  function start() {
    body.innerHTML = ""
      + '<p class="lead">In about a minute, see how your symptoms score across three areas \u2014 and what tends to help. Nothing is stored or sent.</p>'
      + '<ul class="ticks">'
  ...
  function computeScores() {
    ...
    var subs = [
      ...
      { nm: GROUP_NAMES[1], v: sums[1], max: 16, b: sums[1] <= 1 ? 0 : sums[1] <= 3 ? 1 : sums[1] <= 6 ? 2 : 3 },
      { nm: GROUP_NAMES[2], v: sums[2], max: 12, b: sums[2] === 0 ? 0 : sums[2] === 1 ? 1 : sums[2] <= 3 ? 2 : 3 }
    ];
  ...
  function result() {
    ...
    var interp = tb === 0 ? "Your symptoms look minimal overall." :
      tb === 1 ? "Your symptoms look mild overall \u2014 common around this stage." :
      tb === 2 ? "Your symptoms look moderate overall \u2014 common in perimenopause, and often very manageable." :
      "Your symptoms look marked overall. It is worth taking this to a clinician \u2014 and there is a lot that can help.";
    var sub = "";
    ...
    var embedSection = EMBED ? "" :
      ...
      + '&lt;iframe src="' + EMBED_SRC + '" width="100%" height="640" loading="lazy" style="border:0;max-width:560px" title="Menopause symptom score"&gt;&lt;/iframe&gt;'
    ...
    body.innerHTML = ""
      ...
      + embedSection
      + '<p class="disc">This is a screening tool, not a diagnosis. The Menopause Rating Scale measures symptom burden, not a medical condition. Speak to a qualified clinician about your symptoms and before changing any medication.</p>';
  ...
  function downloadPdf(r) {
    ...
    loadJsPDF(function () {
      try {
        ...
        doc.text("Your Menopause Symptom Score", M, y); y += 24;
        ...
        var note = doc.splitTextToSize("This is a screening tool based on the Menopause Rating Scale, not a diagnosis. Take this score to a qualified clinician to discuss your symptoms. Get your free personalised plan at " + CTA_URL, 483);
        doc.text(note, M, y);
        doc.save("menopause-symptom-score.pdf");
  ...
  function build() {
    ...
    root.innerHTML = ""
      ...
      + '<h3>Menopause symptom score</h3>'
      + '<div class="sub">11 quick questions \u00b7 based on the Menopause Rating Scale</div></div>'
